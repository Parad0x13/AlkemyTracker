...
class Alchemy:
    ...
    def addItem(self, newItem = None):
        ...
        for item in items:
            ...
            self.addRecipe((item, newItem), UNKNOWN)
    ...
    def removeRecipe(self, recipe = None):
        ...
        if recipe in self.recipes:
            ...
            #self.addRecipe((a, b), UNKNOWN)

        # Now we go back and ensure all existing items still have an awaiting recipe
        for item in self.getItems(): self.addItem(item)
